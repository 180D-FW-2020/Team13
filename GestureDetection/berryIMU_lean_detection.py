...
# ACCx -25.00 ACCy -104.00 ACCz 8430.00 
...
while True:
    ...
    accX_array.insert(0,ACCx)
    accY_array.insert(0,ACCy)
    accZ_array.insert(0,ACCz)
    ...
    if 0:
        ...
        ACCy1 = ACCy - ACCy0
        ACCz1 = ACCz - ACCz0
        outputString = "\t# ACCx %5.2f ACCy %5.2f ACCz %5.2f # " % (ACCx1, ACCy1, ACCz1)
    
    #if len(accX_array)>300:
    #    avgAccx = sum(accX_array)/len(accX_array)
    #    avgAccy = sum(accY_array)/len(accY_array)
    #    avgAccz = sum(accZ_array)/len(accZ_array)
    #    outputString += "\t# ACCx_average %5.2f ACCy_average %5.2f ACCz_average %5.2f # " % (avgAccx, avgAccy, avgAccz)
    #    break
    ...
    if 1:                       #Change to '0' to stop showing the angles from the accelerometer
        ...
        if ((AccXangle > 45) and (AccYangle < 45)) and (AccYangle > -45):
            outputString += "front" # direction 1
        elif ((AccXangle < -45) and (AccYangle < 45)) and (AccYangle > -45):
            outputString += "back" # direction 2
        elif ((AccYangle > 45) and (AccXangle < 45)) and (AccXangle > -45):
            outputString += "left" # direction 3
        elif ((AccYangle < -45) and (AccXangle < 45)) and (AccXangle > -45):
            outputString += "right" # direction 4 
        else:
